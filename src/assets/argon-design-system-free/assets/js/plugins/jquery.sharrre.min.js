    ...
    (function() {
        ...
        return {
            ...
            get: function(b, c) {
                return a[b]
                    ? new a[b](c)
                    : (console.error('Sharrre - No platform found for ' + b),
                      !1);
            }
        };
    })();
SharrrePlatform.register('delicious', function(a) {
    return (
        ...
        (defaultSettings = $.extend(!0, {}, defaultSettings, a)),
        {
            ...
            load: function(a) {
                if ('tall' == a.options.buttons.delicious.size)
                    var b = 'width:50px;',
                        c =
            ...
            popup: function(a) {
                window.open(
                    'https://www.delicious.com/save?v=5&noui&jump=close&url=' +
                        encodeURIComponent(
                            '' !== this.settings.url ? this.settings.url : a.url
                        ) +
                        '&title=' +
                        a.text,
                    'delicious',
                    'toolbar=no,width=' +
                        this.settings.popup.width +
                        ', height=' +
            ...
            (defaultSettings = $.extend(!0, {}, defaultSettings, a)),
            {
                ...
                load: function(a) {
                    ...
                    $(a.element)
                        ...
                        (window.___gcfg = { lang: b.lang });
                    var c = 0;
                    ('undefined' != typeof gapi &&
                        'undefined' != typeof gapi.plusone) ||
                    0 != c
                        ? gapi.plusone.go()
                        : ((c = 1),
                          (function() {
        ...
        return (
            ...
            (defaultSettings = $.extend(!0, {}, defaultSettings, a)),
            {
                ...
                load: function(a) {
                    ...
                    var c = 0;
                    'undefined' == typeof window.IN && 0 == c
                        ? ((c = 1),
                          (function() {
                              var a = document.createElement('script');
                              (a.type = 'text/javascript'),
            ...
            (defaultSettings = $.extend(!0, {}, defaultSettings, a)),
            {
                ...
                load: function(a) {
                    ...
                    'undefined' == typeof STMBLPN && 0 == c
                        ...
                        : ((STMBLPN.wasProcessLoaded = !1),
                          STMBLPN.processWidgets());
                },
                tracking: function() {},
                popup: function(a) {
                    window.open(
                        'https://www.stumbleupon.com/badge/?url=' +
                            encodeURIComponent(
                                '' !== this.settings.url
                                    ? this.settings.url
                                    : a.url
                ...
                popup: function(a) {
                    window.open(
                        'https://twitter.com/intent/follow?screen_name=' +
                            encodeURIComponent(this.settings.user),
                        '',
                        'toolbar=0, status=0, ,width=' +
                            this.settings.popup.width +
                            ', height=' +
     ...
     */ (function(a, b, c, d) {
        ...
        (f.prototype.init = function() {
            ...
            a.each(b.options.share, function(a, c) {
                c === !0 &&
                    (b.platforms[a] = SharrrePlatform.get(
                        a,
                        b.options.buttons[a]
                    ));
            }),
                ...
                a(this.element).click(function(a) {
                    return (
                        a.preventDefault(), b.options.click(b, b.options), !1
                    );
                });
        }),
            (f.prototype.loadButtons = function() {
                ...
                a(this.element).append('<div class="buttons"></div>'),
                    a.each(b.options.share, function(a, c) {
                        1 == c &&
                            (b.platforms[a].load(b),
                            b.options.enableTracking === !0 &&
                                b.platforms[a].tracking());
                    });
            }),
            ...
            (f.prototype.openPopup = function(a) {
                this.platforms[a].popup(this.options),
                    this.options.enableTracking === !0 &&
                        ((infos = this.platforms[a].trackingAction),
            ...
            (a.fn[g] = function(b) {
                ...
                return b === d || 'object' == typeof b
                    ? this.each(function() {
                          a(this).data('plugin_' + g) ||
                              a(this).data('plugin_' + g, new f(this, b));
                      })
