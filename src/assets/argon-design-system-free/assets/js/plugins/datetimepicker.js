      ...
      */
                    ...
                    if (self.daysContainer !== undefined) {
                        ...
                        self.calendarContainer.style.width =
                            ...
                            (self.weekWrapper !== undefined
                                ...
                                : 0) +
                            'px';
                        self.calendarContainer.style.removeProperty(
                            'visibility'
                        );
        ...
        function onMouseOver(elem) {
            ...
            for (var t = rangeStartDate; t < lastDate; t += duration.DAY) {
                if (!isEnabled(new Date(t), true)) {
                    containsDisabled =
                        containsDisabled ||
                        (t > rangeStartDate && t < rangeEndDate);
                    ...
                    if (elem !== undefined) {
                        ...
                        if (
                            ...
                            !(
                                m > 0 &&
                                prevMonth &&
                                prevMonth.lastChild.dateObj.getTime() >=
                                    timestamp
                            )
                        ) {
                            if (
        ...
        function minMaxDateSetter(type) {
            return function(date) {
                var dateObj = (self.config[
                    '_' + type + 'Date'
                ] = self.parseDate(date, self.config.dateFormat));
                var inverseDateObj =
                    self.config[
                        '_' + (type === 'min' ? 'max' : 'min') + 'Date'
                    ];
        ...
        function positionCalendar(customPositionElement) {
            ...
            var calendarHeight = Array.prototype.reduce.call(
                ...
                configPosHorizontal =
                    configPos.length > 1 ? configPos[1] : null,
        ...
        function selectDate(e) {
            ...
            if (self.config.mode === 'single')
                ...
                if (
                    compareDates(selectedDate, self.selectedDates[0], true) !==
                    0
                )
        ...
        function setSelectedDate(inputDate, format) {
            ...
            if (inputDate instanceof Array)
                ...
                self.config.errorHandler(
                    new Error(
                        'Invalid date supplied: ' + JSON.stringify(inputDate)
                    )
                );
